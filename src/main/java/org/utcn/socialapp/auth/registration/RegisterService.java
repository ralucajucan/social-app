...
public class RegisterService{
    ...
    public RegisterService(EmailValidator emailValidator, EmailService emailService, UserRepository userRepository,
                           ProfileRepository profileRepository, BCryptPasswordEncoder bCryptPasswordEncoder,
    ...
    public RegisterToken register(RegisterDTO registerDTO) throws BusinessException {
        ...
        emailService.sendRegisterToken(registerDTO.getEmail(), emailService.buildRegisterEmail(registerDTO.getFirstName(), link));
    ...
    public String enableUserWithToken(String uuid) throws BusinessException {
        RegisterToken registerToken = registerTokenService.getToken(uuid).orElseThrow(() -> new BusinessException(NOT_FOUND));
